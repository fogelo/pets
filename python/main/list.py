...
myListRepr = myList.__repr__() # repr(myList) - возвращает строковое представление объекта для программистов, repr - representation
...
1) если index < 0, то отсчет будет начинаться с конца списка
