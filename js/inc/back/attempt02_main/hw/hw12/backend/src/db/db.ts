...
import { PostLike } from "../features/posts/domain/post-like";

const USER_COLLECTION_NAME = "users";
const BLOG_COLLECTION_NAME = "blogs";
const POST_COLLECTION_NAME = "posts";
const POST_LIKE_COLLECTION_NAME = "post-likes";
...
export let postLikesCollection: Collection<PostLike>;
...
export const DbManager = {
  ...
  async startDb() {
    ...
    postLikesCollection = this.db.collection<PostLike>(POST_LIKE_COLLECTION_NAME);
