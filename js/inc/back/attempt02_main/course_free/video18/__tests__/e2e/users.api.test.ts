...
import { UserType, db } from "../../src/db/db";
import { ViewUserModel } from "../../src/features/users/models/ViewUserModel";
import { CreateUserModel } from "../../src/features/users/models/CreateUserModel";
import { mapUserToViewModel } from "../../src/features/users/users.router";

const testDbUserData: UserType[] = [
...
const testViewUserData: ViewUserModel[] =
  testDbUserData.map(mapUserToViewModel);
